...
import (
	"github.com/tamihyo/bookstore_users-api/domain/users"
...
/*tidy the services*/
/*
we have a variable call users services of type userserviceinterface
beign an instance of user service
*/
var (
...
/*entire business proses is in here*/
/*passing usersService as a method*/
...
func (s *usersService) DeleteUser(userId int64) *rest_errors.RestErr {
	_, err := UsersService.GetUser(userId)
	if err != nil {
		return err
	}
